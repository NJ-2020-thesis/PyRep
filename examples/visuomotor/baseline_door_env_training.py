...
model_path = "/home/anirudh/HBRS/Master-Thesis/NJ-2020-thesis/PyRep/examples/visuomotor/results/model_saved.mdl"
...
class ReacherEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.gripper_state = gripper.get_configuration_tree()
        door = Shape('door_frame')
        self.door_state = door.get_configuration_tree()
